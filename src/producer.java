...
public class producer implements OnInterestCallback, OnRegisterFailed {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Face face = signFace(new Face());
			face.registerPrefix(new Name("/maps"), producer, producer);
			System.out.println("starting processEvents");
			while (true) {
				Thread.sleep(10);
				face.processEvents();
			}
	...
	private static Face signFace(Face face) throws SecurityException {
		// use memory storage
	...
	public void onInterest(Name arg0, Interest arg1, Face arg2, long arg3, InterestFilter arg4) {
		System.out.println("interestreceived");
		System.out.println("interest : " + arg1.getName().toString());
		Data data = new Data(arg0);
		String s = "http://tile.openstreetmap.org";
		String sn = arg1.getName().toString();
		String t = sn.substring(5);
		data.setName(arg1.getName());
		String query = s + t + ".png";
		...
		try {
			...
			System.out.println(Face.getMaxNdnPacketSize());
		...
		try {
			arg2.putData(data, WireFormat.getDefaultWireFormat());
			System.out.println("Sent data: " + data.getName().toString() + ", " + data.getContent().toString());
	...
	public void onRegisterFailed(Name arg0) {
		System.out.println("Failed to register " + arg0.toString());
